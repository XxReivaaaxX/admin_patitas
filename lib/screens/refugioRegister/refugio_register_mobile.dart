...
class RefugioRegisterMobile extends StatefulWidget {
  final VoidCallback registerRefugio;
  final TextEditingController nombreController;
  final TextEditingController direccionController;
  final GlobalKey<FormState> formkey;
  const RefugioRegisterMobile({
    super.key,
  ...
  @override
  State<RefugioRegisterMobile> createState() => _RefugioRegisterMobileState();
}

class _RefugioRegisterMobileState extends State<RefugioRegisterMobile> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Form(
          key: widget.formkey,
          child: Container(
            margin: EdgeInsets.only(bottom: 40, left: 70, right: 70, top: 5),
            child: ListView(
              shrinkWrap: true,
              children: [
                Container(
