                  ...
                  children: [
                    Expanded(
                      child: _buildFeatureCard(
                        ...
                        description:
                            'Administra animales, controla el estado de salud, organiza vacunas y gestiona a tus colaboradores fácilmente.',
                      ),
                    ),
                    ...
                    Expanded(
                      child: _buildFeatureCard(
                        ...
                        description:
                            'Los usuarios pueden ver los animales disponibles, llenar formularios detallados y seguir el proceso online.',
                      ),
                    ),
                    const SizedBox(width: 30),
                    Expanded(
                      child: _buildFeatureCard(
                        ...
                        description:
                            'Notifica automáticamente por correo electrónico a los solicitantes cuando su solicitud de adopción sea aprobada.',
                      ),
                    ),
                  ],
                )
